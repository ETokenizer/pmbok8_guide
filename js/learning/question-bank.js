...
const localBank = [
    ...
    { id:'L_P5_Q1', category:'principle', categoryId:5, difficulty:'easy', question:'PMBOK第8版"可持续性"原则的核心是什么？', options:['A. 只关注项目利润','B. 平衡人、利润、地球三重底线，负责任地使用资源','C. 忽略环境影响追求速度','D. 仅关注短期经济效益'], correct:1, explanation:'三重底线（Triple Bottom Line）是可持续性原则的核心。' },
    { id:'L_P6_Q1', category:'principle', categoryId:6, difficulty:'easy', question:'PMBOK第8版"构建赋能文化"原则的核心是什么？', options:['A. 严格控制团队行为','B. 促进信任、尊重多样性，打造积极协作的工作环境','C. 只关注技术能力提升','D. 减少团队成员之间的沟通'], correct:1, explanation:'赋能文化的核心是信任和尊重多样性。' },
