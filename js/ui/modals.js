    ...
    if ((itemType === 'input' || itemType === 'output') && (reg.o.length > 0 || reg.i.length > 0)) {
        chainHTML = `<div class="itto-chain-section chain-viz">
            ...
            <div class="itto-flow-chain-v2">
                ...
                ${reg.o.length > 0 ? `<div class="flow-connector"><span class="flow-arrow-text">产出</span><span class="flow-arrow-icon">▼</span></div>` : ''}
                ...
                ${reg.i.length > 0 ? `<div class="flow-connector"><span class="flow-arrow-text">输入</span><span class="flow-arrow-icon">▼</span></div>` : ''}
